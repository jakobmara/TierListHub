...
def getTemplateJson(templateId):
    ...
    if template_data is not None:
        template_data['imageUrls'] = [url_for('getImageFromTemplate', \
            templateId= template_data['templateId'], imageId= imageId, _external=True) for imageId in template_data['imageIds']]
        print(template_data)
